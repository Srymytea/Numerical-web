...
class Graphical extends Component{
    ...
    Cal_Graphical(){
        ...
        var x_end = Number(document.getElementById("input_end").value);
                ...
                <div style={mainDiv}>
                    <div style={Div}>
                        ...
                        <div>
                            ...
                            <Form.Control id="inout_end" type="number" placeholder="input end" style={{width:"10%", margin:"0 auto"}}></Form.Control>
                        </div>
                        <br/>
